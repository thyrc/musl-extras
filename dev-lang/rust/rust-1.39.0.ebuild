...
PATCHES=( "${FILESDIR}"/1.36.0-libressl.patch
		  "${FILESDIR}"/${PN}-1.39.0-Require-static-native-libraries-when-linking-static.patch
          "${FILESDIR}"/${PN}-1.39.0-Remove-nostdlib-and-musl_root.patch
          "${FILESDIR}"/${PN}-1.33.0-Switch-musl-targets-to-link-dynamically-by-default.patch
          "${FILESDIR}"/${PN}-1.39.0-Fix-vendor-linux_musl_base-checksum.patch
          ...
          "${FILESDIR}"/${PN}-1.39.0-Fix-vendor-liblibc-checksum.patch
