...
PATCHES=( "${FILESDIR}"/${PN}-1.33.0-Require-static-native-libraries-when-linking-static.patch
          "${FILESDIR}"/${PN}-1.33.0-Remove-nostdlib-and-musl_root.patch
          "${FILESDIR}"/${PN}-1.33.0-Switch-musl-targets-to-link-dynamically-by-default.patch
          "${FILESDIR}"/${PN}-1.33.0-Fix-vendor-linux_musl_base-checksum.patch
          ...
          "${FILESDIR}"/${PN}-1.33.0-Fix-vendor-liblibc-checksum.patch
		  ...
		  "${FILESDIR}"/${PN}-1.32.0-fix-configure-of-bundled-llvm.patch
          "${FILESDIR}"/${PN}-1.33.0-clippy-sysroot.patch
)
