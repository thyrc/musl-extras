...
PATCHES=( "${FILESDIR}"/0001-llvm-cmake-Add-additional-headers-only-if-they-exist.patch
          "${FILESDIR}"/${PN}-1.33.0-Require-static-native-libraries-when-linking-static.patch
          "${FILESDIR}"/${PN}-1.35.0-Remove-nostdlib-and-musl_root.patch
          ...
          "${FILESDIR}"/${PN}-1.35.0-Fix-vendor-liblibc-checksum.patch
