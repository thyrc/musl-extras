...
PATCHES=(
	"${FILESDIR}/${PN}-1.28.0-Require-static-native-libraries-when-linking-static.patch"
	"${FILESDIR}/${PN}-1.28.0-Switch-musl-targets-to-link-dynamically-by-default.patch"
