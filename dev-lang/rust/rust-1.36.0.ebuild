...
PATCHES=( "${FILESDIR}"/0001-llvm-cmake-Add-additional-headers-only-if-they-exist.patch
          ...
          "${FILESDIR}"/${PN}-1.36.0-Remove-nostdlib-and-musl_root.patch
          "${FILESDIR}"/${PN}-1.33.0-Switch-musl-targets-to-link-dynamically-by-default.patch
          "${FILESDIR}"/${PN}-1.35.0-Fix-vendor-linux_musl_base-checksum.patch
          ...
          "${FILESDIR}"/${PN}-1.36.0-Fix-vendor-liblibc-checksum.patch
