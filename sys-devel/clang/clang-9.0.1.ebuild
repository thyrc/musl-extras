...
IUSE="debug default-compiler-rt default-libcxx doc +static-analyzer
	hardened test xml kernel_FreeBSD ${ALL_LLVM_TARGETS[*]}"
...
HARDENED_PATCHES=(
	"${FILESDIR}"/8.0.1/hardened/0001-Use-z-relro-on-Gentoo.patch
	"${FILESDIR}"/9.0.1/hardened/0002-Enable-Stack-Protector-by-default.patch
	"${FILESDIR}"/6.0.0/hardened/0003-Enable-PIE-by-default.patch
	"${FILESDIR}"/7.1.0/hardened/0004-Enable-FORTIFY_SOURCE-macro-by-default.patch
	"${FILESDIR}"/8.0.1/hardened/0005-Link-with-z-now-by-default-for-Gentoo.patch
)
