...
src_configure() {
	...
	ln -s "${FILESDIR}/3.14/icedtea-hotspot-musl.patch" patches || die
	ln -s "${FILESDIR}/3.14/icedtea-hotspot-musl-ppc.patch" patches || die
	ln -s "${FILESDIR}/3.14/icedtea-hotspot-noagent-musl.patch" patches || die
	ln -s "${FILESDIR}/3.14/icedtea-jdk-execinfo.patch" patches || die
	ln -s "${FILESDIR}/3.14/icedtea-jdk-fix-libjvm-load.patch" patches || die
	ln -s "${FILESDIR}/3.14/icedtea-jdk-fix-ipv6-init.patch" patches || die
	ln -s "${FILESDIR}/3.14/icedtea-jdk-musl.patch" patches || die
	ln -s "${FILESDIR}/3.14/icedtea-jdk-getmntent-buffer.patch" patches || die
	ln -s "${FILESDIR}/3.14/icedtea-autoconf-config.patch" patches || die
	ln -s "${FILESDIR}/3.14/icedtea-jdk-includes.patch" patches || die
	ln -s "${FILESDIR}/3.14/icedtea-jdk-fix-gcc-check.patch" patches || die
	ln -s "${FILESDIR}/3.14/fix-paxmark.patch" patches || die
	...
	DISTRIBUTION_PATCHES+="patches/icedtea-hotspot-musl.patch "
	DISTRIBUTION_PATCHES+="patches/icedtea-hotspot-musl-ppc.patch "
	DISTRIBUTION_PATCHES+="patches/icedtea-hotspot-noagent-musl.patch "
	DISTRIBUTION_PATCHES+="patches/icedtea-jdk-execinfo.patch "
	DISTRIBUTION_PATCHES+="patches/icedtea-jdk-fix-libjvm-load.patch "
	DISTRIBUTION_PATCHES+="patches/icedtea-jdk-fix-ipv6-init.patch "
	DISTRIBUTION_PATCHES+="patches/icedtea-jdk-musl.patch "
	DISTRIBUTION_PATCHES+="patches/icedtea-jdk-getmntent-buffer.patch "
	DISTRIBUTION_PATCHES+="patches/icedtea-autoconf-config.patch "
	DISTRIBUTION_PATCHES+="patches/icedtea-jdk-includes.patch "
	DISTRIBUTION_PATCHES+="patches/icedtea-jdk-fix-gcc-check.patch "
	DISTRIBUTION_PATCHES+="patches/fix-paxmark.patch "
