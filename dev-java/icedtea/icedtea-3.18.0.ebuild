...
src_configure() {
	...
	ln -s "${FILESDIR}/icedtea8-jdk-fix-gcc-check.patch" patches || die
	ln -s "${FILESDIR}/3.17/icedtea-autoconf-config.patch" patches || die
	ln -s "${FILESDIR}/3.17/icedtea-hotspot-insantiate-arrayallocator.patch" patches || die
	ln -s "${FILESDIR}/3.17/icedtea-hotspot-musl.patch" patches || die
	ln -s "${FILESDIR}/3.17/icedtea-hotspot-musl-ppc.patch" patches || die
	ln -s "${FILESDIR}/3.17/icedtea-hotspot-noagent-musl.patch" patches || die
	ln -s "${FILESDIR}/3.17/icedtea-jdk-close-fds.patch" patches || die
	ln -s "${FILESDIR}/3.17/icedtea-jdk-execinfo.patch" patches || die
	ln -s "${FILESDIR}/3.17/icedtea-jdk-fix-ipv6-init.patch" patches || die
	ln -s "${FILESDIR}/3.17/icedtea-jdk-fix-libjvm-load.patch" patches || die
	ln -s "${FILESDIR}/3.17/icedtea-jdk-musl.patch" patches || die
	...
	DISTRIBUTION_PATCHES+="patches/icedtea8-jdk-fix-gcc-check.patch "
	DISTRIBUTION_PATCHES+="patches/icedtea-autoconf-config.patch "
	DISTRIBUTION_PATCHES+="patches/icedtea-hotspot-insantiate-arrayallocator.patch "
	...
	DISTRIBUTION_PATCHES+="patches/icedtea-jdk-close-fds.patch "
