...
CORBA_GENTOO_TARBALL="icedtea${SLOT}-corba-${PV}.tar.xz"
JAXP_GENTOO_TARBALL="icedtea${SLOT}-jaxp-${PV}.tar.xz"
JAXWS_GENTOO_TARBALL="icedtea${SLOT}-jaxws-${PV}.tar.xz"
JDK_GENTOO_TARBALL="icedtea${SLOT}-jdk-${PV}.tar.xz"
LANGTOOLS_GENTOO_TARBALL="icedtea${SLOT}-langtools-${PV}.tar.xz"
OPENJDK_GENTOO_TARBALL="icedtea${SLOT}-openjdk-${PV}.tar.xz"
NASHORN_GENTOO_TARBALL="icedtea${SLOT}-nashorn-${PV}.tar.xz"
HOTSPOT_GENTOO_TARBALL="icedtea${SLOT}-hotspot-${PV}.tar.xz"
SHENANDOAH_GENTOO_TARBALL="icedtea${SLOT}-shenandoah-${PV}.tar.xz"
