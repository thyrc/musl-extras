...
CORBA_TARBALL="515d4240643c.tar.xz"
JAXP_TARBALL="7cf58dbfacc0.tar.xz"
JAXWS_TARBALL="a1570643cc66.tar.xz"
JDK_TARBALL="5a429ac0ea1b.tar.xz"
LANGTOOLS_TARBALL="102d7b3ffe9e.tar.xz"
OPENJDK_TARBALL="f461af66b1b2.tar.xz"
NASHORN_TARBALL="e48fc93a378c.tar.xz"
HOTSPOT_TARBALL="162cf03637c7.tar.xz"
...
src_configure() {
	...
	ln -s "${FILESDIR}/${PN}8-jdk-fix-gcc-check.patch" patches || die
	...
	DISTRIBUTION_PATCHES+="patches/${PN}8-jdk-fix-gcc-check.patch "
