...
SRC_URI="${PN}-core-${PV}-${abi}alpine.tar.xz"

DESCRIPTION="A Alpine / self-made binary build of the IcedTea JDK"
HOMEPAGE="http://icedtea.classpath.org"
LICENSE="GPL-2-with-classpath-exception"
SLOT="8"

IUSE="-alsa -cups doc examples +gtk headless-awt multilib nsplugin pulseaudio selinux -webstart"
...
multilib_src_install() {
	...
	if multilib_is_native_abi; then
		...
		cp -pRP ${P}-${ABI}/{bin,include,jre,lib} "${ddest}" || die
