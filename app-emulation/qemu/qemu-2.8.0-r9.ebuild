...
PATCHES=(
	...
	"${FILESDIR}"/0001-elfload-load-PIE-executables-to-right-address.patch
	"${FILESDIR}"/0006-linux-user-signal.c-define-__SIGRTMIN-MAX-for-non-GN.patch
	"${FILESDIR}"/0001-linux-user-fix-build-with-musl-on-aarch64.patch
	"${FILESDIR}"/musl-F_SHLCK-and-F_EXLCK.patch
	"${FILESDIR}"/fix-sigevent-and-sigval_t.patch
	"${FILESDIR}"/xattr_size_max.patch
	"${FILESDIR}"/ncurses.patch
	"${FILESDIR}"/ignore-signals-33-and-64-to-allow-golang-emulation.patch
)
