...
src_prepare() {
	...
	epatch "${FILESDIR}"/0001-elfload-load-PIE-executables-to-right-address.patch
	epatch "${FILESDIR}"/0006-linux-user-signal.c-define-__SIGRTMIN-MAX-for-non-GN.patch
	epatch "${FILESDIR}"/0001-linux-user-fix-build-with-musl-on-aarch64.patch
	epatch "${FILESDIR}"/musl-F_SHLCK-and-F_EXLCK.patch
	epatch "${FILESDIR}"/fix-sigevent-and-sigval_t.patch
	epatch "${FILESDIR}"/xattr_size_max.patch
	epatch "${FILESDIR}"/ncurses.patch
	epatch "${FILESDIR}"/ignore-signals-33-and-64-to-allow-golang-emulation.patch
