...
PATCHES=(
	...
	"${FILESDIR}"/${PN}-3.1.0-0001-elfload-load-PIE-executables-to-right-address.patch
	...
	"${FILESDIR}"/${PN}-3.1.0-0006-linux-user-signal.c-define-__SIGRTMIN-MAX-for-non-GN.patch
